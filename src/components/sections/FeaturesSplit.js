...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    title: 'Our Mission',
    paragraph: 'To offer the world a secure and efficient method to exchange stock from private companies, in the blink of an eye, and to allow anyone to benefit from the growing startup ecosystem by democratizing access to private investment.'
  };
